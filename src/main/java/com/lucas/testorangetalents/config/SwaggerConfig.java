...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.lucas.testorangetalents.resources"))
	...
	private ApiInfo apiInfo() {
		 return new ApiInfo(
		 "API do teste da Origin Talents",
		 "Esta API é utilizada no teste da Origin talents",
		 "Versão 1.0",
		 "https://github.com/LucasJordao",
		 new Contact("Lucas William", "github.com/LucasJordao", "lucaswill12@hotmail.com"),
